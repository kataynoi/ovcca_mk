...
class Kato extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->layout->view("kato/kato_person_list_view.php", $data);
    }
    ...
    function fetch_person(){
        $fetch_data = $this->kato->make_datatables();
        $data = array();
        ...
        $output = array(
            ...
            "recordsTotal"              =>     $this->kato->get_all_data(),
            "recordsFiltered"           =>     $this->kato->get_filtered_data(),
            "data"                      =>     $data
        );
    ...
    public  function kato ($cid,$id,$view=''){
        ...
        if($id!=0){
            $data['answer'] = $this->kato->get_answer($id);
            $data['action'] = 'update';
        }
        else
        {$data['action'] = 'insert';}
        ...
        $data['cid']= $cid;
        //$data['history_answer']= $this->kato->get_history($cid,$this->hospcode);
