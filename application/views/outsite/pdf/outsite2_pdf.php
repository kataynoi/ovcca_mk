...
// $pdf->SetFont('freeserif', '', 12);
    ...
    switch  ($pageNo){
        case 1:
            ...
            $pdf->Cell(250, 0, to_thai_number_text($out_site->invit_subject), 0, 0, 'L');
            $pdf->setXY(66, $line[13]+1.65);
            $pdf->Cell(250, 0, $out_site->invit_type, 0, 0, 'L');
            if($out_site->invit_start_date == $out_site->invit_end_date){
                $pdf->setXY(112, $line[13]+1.65);
